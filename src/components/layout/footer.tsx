      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-2 font-body text-white/60">
            ...
            <li><a href="https://form.typeform.com/to/kBg1xSHF" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Elite 1:1 Coaching</a></li>
          </ul>
        </div>
