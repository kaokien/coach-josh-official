...
const ProblemSection = () => {
  return (
    <section className="relative px-6 py-24 md:px-12 bg-[#D1495B] border-y-4 border-[#1A1A1A]">
      <div className="mx-auto max-w-6xl">
        <div className="mb-16 text-center">
          <div className="inline-block bg-[#1A1A1A] px-4 py-1 mb-4 transform -rotate-2">
          ...
          <p className="mt-6 text-xl md:text-2xl font-bold text-[#1A1A1A] max-w-2xl mx-auto bg-white/10 backdrop-blur-sm p-4 border-2 border-[#1A1A1A]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-[#F2E8DC] border-4 border-[#1A1A1A] p-6 shadow-[8px_8px_0px_0px_rgba(26,26,26,1)] relative overflow-hidden group hover:translate-y-1 transition-transform">
            <div className="absolute top-0 right-0 p-2 opacity-10 group-hover:opacity-20 transition-opacity">
              <MonitorPlay size={120} />
            </div>
            <div className="bg-[#1A1A1A] w-12 h-12 flex items-center justify-center mb-4">
              <MonitorPlay className="text-white" size={24} />
            </div>
            <h3 className="font-display text-2xl uppercase mb-3 text-[#1A1A1A]">YouTube University</h3>
            <p className="font-body text-[#1A1A1A]/80 font-medium">
          ...
          <div className="bg-[#F2E8DC] border-4 border-[#1A1A1A] p-6 shadow-[8px_8px_0px_0px_rgba(26,26,26,1)] relative overflow-hidden group hover:translate-y-1 transition-transform">
            ...
            <h3 className="font-display text-2xl uppercase mb-3 text-[#1A1A1A]">Zero Feedback</h3>
            <p className="font-body text-[#1A1A1A]/80 font-medium">
          ...
          <div className="bg-[#F2E8DC] border-4 border-[#1A1A1A] p-6 shadow-[8px_8px_0px_0px_rgba(26,26,26,1)] relative overflow-hidden group hover:translate-y-1 transition-transform">
            ...
            <h3 className="font-display text-2xl uppercase mb-3 text-[#1A1A1A]">Cardio Boxing</h3>
            <p className="font-body text-[#1A1A1A]/80 font-medium">
