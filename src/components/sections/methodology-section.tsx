...
const MethodologySection = () => {
  return (
    <section className="relative px-6 py-24 md:px-12 bg-[#FFFFFF]">
      <div className="mx-auto max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-block bg-[#2563EB] px-4 py-1 mb-4 transform rotate-1">
              <span className="font-display text-white text-lg tracking-widest uppercase">The Solution</span>
            </div>
            <h2 className="font-display text-4xl md:text-6xl uppercase leading-none text-[#0F172A] mb-6">
              The <span className="text-[#2563EB]">Fight IQ</span> System
            </h2>
            <p className="text-xl font-body font-bold text-[#0F172A]/80 leading-relaxed mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                <div className="bg-[#0F172A] p-3 h-fit border-2 border-[#0F172A] shadow-[4px_4px_0px_0px_#2563EB]">
                  <Zap className="text-white" size={24} />
                </div>
                <div>
                  <h3 className="font-display text-2xl uppercase text-[#0F172A]">1. Mechanics</h3>
                  <p className="font-body text-[#0F172A]/70">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-display text-2xl uppercase text-[#0F172A]">2. Strategy</h3>
                  <p className="font-body text-[#0F172A]/70">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-display text-2xl uppercase text-[#0F172A]">3. Mentality</h3>
                  <p className="font-body text-[#0F172A]/70">
          ...
          <div className="relative">
            ...
            <div className="aspect-square bg-[#0F172A] p-8 border-4 border-[#0F172A] shadow-[12px_12px_0px_0px_rgba(209,73,91,1)]">
              <div className="h-full w-full border-4 border-white/20 p-8 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center z-10">
                  ...
                  <div className="font-display text-2xl text-[#2563EB] uppercase tracking-[0.5em] bg-white px-2 mt-4">Unlocked</div>
                </div>
              </div>
            </div>
          </div>
