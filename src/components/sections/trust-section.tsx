...
export default function TrustSection() {
  return (
    // CHANGED: bg-white -> bg-[#FFFFFF]
    <section className="border-t-2 border-[#0F172A] bg-[#FFFFFF] px-6 py-24 md:px-12">
      <div className="mx-auto max-w-7xl">

        {/* --- HEADER --- */}
        <div className="text-center mb-20">
          {/* CHANGED: bg-[#FFFFFF] -> bg-white (to pop against the tan background) */}
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-8">
            {/* Image Card */}
            <div className="relative border-4 border-[#0F172A] bg-[#0F172A] shadow-[12px_12px_0px_0px_#0F172A]">
              <div className="relative aspect-[3/4] w-full grayscale contrast-125 hover:grayscale-0 transition-all duration-500">
                <Image
                  ...
                  priority
                />
                <div className="absolute inset-0 bg-[#2563EB]/20 mix-blend-multiply pointer-events-none" />
              </div>

              {/* Badge */}
              <div className="absolute -bottom-6 -right-6 border-2 border-[#0F172A] bg-[#DC2626] px-6 py-3 font-display text-xl text-white shadow-[4px_4px_0px_0px_#0F172A]">
                Est. 2020
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 border-2 border-[#0F172A] bg-white p-4 shadow-[8px_8px_0px_0px_#0F172A]">
              ...
              <div className="text-center border-l-2 border-[#0F172A]/20">
                <div className="font-display text-3xl md:text-4xl text-[#0F172A]">6+</div>
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            {/* Opening Hook */}
            {/* CHANGED: bg-[#FFFFFF]/50 -> bg-white (for readability) */}
            ...
            {/* The Story */}
            <div className="space-y-6 font-body text-lg text-[#0F172A]/80 leading-relaxed">
              <p>
                <span className="font-bold text-[#0F172A]">Boxing isn't just a sport.</span> It's a way of life.
              </p>
              <p>
                I've traveled, exposed myself to different styles, and learned from coaches with <span className="bg-[#DC2626]/20 px-1 font-bold text-[#A8314A]">World Championship experience</span>. I have over six years of training in elite gyms, taking in everything I could.
              </p>
              <p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-4">
              {/* Card 1 */}
              <div className="border-2 border-[#0F172A] bg-white p-6 shadow-[4px_4px_0px_0px_#0F172A] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_#0F172A] transition-all">
                <div className="mb-4 inline-flex items-center justify-center h-10 w-10 border-2 border-[#0F172A] bg-[#2563EB] text-white">
                  <Target size={20} />
                </div>
                <h3 className="font-display text-xl uppercase text-[#0F172A] mb-2">My Philosophy</h3>
              ...
              {/* Card 2 */}
              <div className="border-2 border-[#0F172A] bg-[#0F172A] p-6 text-white shadow-[4px_4px_0px_0px_#2563EB] hover:translate-y-[-2px] transition-all">
