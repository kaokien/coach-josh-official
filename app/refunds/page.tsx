  ...
  return (
    <div className="min-h-screen bg-[#F2E8DC]">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        {/* Guarantee Banner */}
        <div className="bg-[#7FB069] border-2 border-[#1A1A1A] p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-8 text-center">
        ...
        <div className="bg-white border-2 border-[#1A1A1A] p-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <div className="prose prose-lg max-w-none font-body">
            ...
            <ol className="text-[#1A1A1A]/80">
              <li>Email <a href="mailto:support@coachjosh.com" className="text-[#4A6FA5] hover:underline">support@coachjosh.com</a> with the subject line &quot;Refund Request&quot;</li>
            ...
            <p className="text-[#1A1A1A]/80">
              If you have any questions about our refund policy, please <Link href="/contact" className="text-[#4A6FA5] hover:underline">contact us</Link>. We&apos;re here to help.
            </p>
          </div>
        </div>
      </main>
