...
import LandingPage from '@/src/components/landing-page'; // Check if this path needs src/
import MerchShowcase from '@/src/components/merch-showcase'; // Adjust path based on where you saved it
